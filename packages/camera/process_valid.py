'''
Image data capture, conversion, transfer exp program
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_convert_hdf', nargs='?', default=False, required=False, help="Testing for Converting images to HDF5")
